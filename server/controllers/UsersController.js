...
const { createAccessToken, createRefreshToken } = require("../middleware/AccessRefreshTokens");
...
const deleteUser = async(req, res) =>{
   ...
   const foundUser = Users.findOne({where: {
        id: id,
    },});
    if(!foundUser){
...
module.exports = { getUsers, addUser, deleteUser, findUserById, updateUser, login, logout, deleteEmployee}