...
//List
router.route('/').get(verifyToken,verifyRole(ROLES_LIST.Admin, ROLES_LIST.Super_User),UsersController.getUsers);
...
//Update
router.route('/update/:id').put(verifyToken,verifyRole(ROLES_LIST.Admin, ROLES_LIST.Super_User),UsersController.updateUser);
//Delete
router.route("/delete/:id").delete(verifyToken,verifyRole(ROLES_LIST.Admin, ROLES_LIST.Super_User),UsersController.deleteUser)
